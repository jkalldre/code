...
void partI()
{
   ...
   // UNCOMMENT THE SECTION AT THE END OF THIS FUNCTION
   ...
   // UNCOMMENT THIS TO COMPLETE PART I
   // Test the Robot:
   Robot robot;
   robot.setPosition(p);
   robot.setEnergy(-10);
...
void partIII()
{
   ...
   Robot r1;
   cout << "Default constructor. Should be: (5, 5) - 84. It is: ";
   r1.display();
   cout << endl;
...
void stretch()
{
   ...
   do
   {
      cout << "Enter a command (w=up, s=down, a=left, d=right, f=fire, q=quit): ";
      cin >> command;
