...
print "<tr><td>Expires: $month, $pieces[1]</td></tr><tr><td>Purchases:<br/>";
if (isset($bpack)) print "Basic Package: $$bpack<br/>";
if (isset($spack)) print "Standard Package: $$spack<br/>";
if (isset($apack)) print "Advanced Package: $$apack<br/>";
if (isset($lpack)) print "Luxury Package: $$lpack";
print "</td></tr><tr><td>Total: $$total</td></tr>";
print "<tr><td><button type='submit' name='action' value='cancel'>Cancel Purchase</button>";
print "<button type='submit' name='action' value='submit'>Confirm</button></td></tr>";
print "</table>";
print "</form>";
print "</body>";
print "</html>";
